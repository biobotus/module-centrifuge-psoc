...
/* Status Register */
#define Status_Reg_2_Status             (* (reg8 *) Status_Reg_2_sts_intr_sts_reg__STATUS_REG )
#define Status_Reg_2_Status_PTR         (  (reg8 *) Status_Reg_2_sts_intr_sts_reg__STATUS_REG )
#define Status_Reg_2_Status_Mask        (* (reg8 *) Status_Reg_2_sts_intr_sts_reg__MASK_REG )
#define Status_Reg_2_Status_Aux_Ctrl    (* (reg8 *) Status_Reg_2_sts_intr_sts_reg__STATUS_AUX_CTL_REG )
